...
public class QQLoginController {
   ...
   public void QQlogin(HttpServletRequest req,HttpServletResponse res,HttpSession session) throws QQConnectException {
   ...
   public String callback(HttpServletRequest req,HttpServletResponse res,HttpSession session) throws QQConnectException{
