            ...
            <form action="" method="post" style="padding:30px;">
                ...
                <div class="layui-row layui-col-space15 layui-form-item">
                    ...
                    <div class="layui-col-md4">
                        ...
                        <div class="layui-input-block">
                            <input type="text" value="${blog.blog_title}" name="blog_title" id="title"
                    ...
                    <div class="layui-col-md4">
                        ...
                        <div class="layui-input-block">
                            <select lay-verify="required" name="blog_state" id="status" lay-filter="tag">
                                ...
                                <option value="<span class='layui-badge'>精贴</span>"><span class="layui-badge">精贴</span>
                                </option>
                                <option value="<span class='layui-badge layui-bg-green'>分享</span>"><span
                                        class="layui-badge layui-bg-green">分享</span></option>
                                <option value="<span class='layui-badge layui-bg-cyan'>置顶</span>"><span
                                        class="layui-badge layui-bg-cyan">置顶</span></option>
                            </select>
                        </div>
                    </div>
                    <div class="layui-col-md4">
                        ...
                        <div class="layui-input-block">
                            <input type="text" lay-verify="required" value="${blog.blog_futitle}" name="blog_futitle"
                                   id="futitle" value=“副标题" class="layui-input">
                ...
                <div class="layui-row layui-col-space15 layui-form-item">
                    <div class="layui-col-md4">
                        <label for="" class="layui-form-label" id="uploadimage" style="cursor: pointer"><i
                                class='layui-icon'></i>&nbsp;封面上传</label>
                        <div class="layui-input-block">
                            <input type="text" lay-verify="required" value="${blog.blog_coverimage}"
                                   name="blog_coverimage" id="blog_coverimage" readonly="readonly" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-col-md4">
                        <label class="layui-form-label">发布时间</label>
                        <div class="layui-input-inline">
                            <input class="layui-input newsTime" value="${blog.blog_time}" name="blog_time"
                                   id="blog_time" lay-verify="required" type="text">
                        </div>
                ...
                <div class="layui-form-item">
                    <div class="layui-col-md4">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="L_vercode" placeholder="请回答后面的问题" autocomplete="off"
                                   class="layui-input">
                        </div>
                    ...
                    <div class="layui-col-md4">
                        ...
                        <div class="layui-form-item">
                            <button class="layui-btn" id="pullBlog" lay-filter="go" lay-submit><i class="layui-icon">&#xe609;</i>立即发布
                            </button>
                        </div>
                    </div>
            ...
            setTimeout(function () {
                $.ajax({
                    ...
                    data: {
                        ...
                        "blog_title": title,
                        "blog_eyes": 0,
                        "blog_futitle": futitle,
                        "blog_time": time,
                        "blog_state": 1,
                        "blog_tag": tag,
                        "blog_type": type,
                        "blog_article": content,
                        "blog_coverimage": $("#blog_coverimage").val()
                    },
                    success: function (res) {
                        layer.close(index1);
                        if (res) {
