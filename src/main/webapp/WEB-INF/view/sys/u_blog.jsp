...
<script type="text/html" id="checkboxTpl">
    <input type="checkbox" name="switch" lay-skin="switch" rowid="{{d.blog_id}}" lay-filter="state"
           value="{{d.blog_state}}" lay-text="显示|隐藏" lay-filter="visable" {{ d.blog_state== 1 ? 'checked' : '' }}>
    ...
    layui.use(['layer', 'table', 'form'], function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {
                    field: 'blog_coverimage',
                    title: '封面',
                    width: "10%",
                    event: 'imageEvent',
                    unresize: true,
                    sort: true,
                    templet: '<div style="height:50px;"><img style="cursor:pointer" class="fmimage"  src="../resource/upload/images/{{d.blog_coverimage}}"></div>'
                }
