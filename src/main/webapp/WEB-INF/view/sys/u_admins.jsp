...
<script type="text/html" id="locked">
    <input type="checkbox" name="sex" value="{{d.id}}" lay-skin="switch" lay-text="是|否" lay-filter="locked" {{
           d.locked== 1 ? 'checked' : '' }}>
    ...
    <form class="layui-form" action="" lay-filter="from1">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="usercode" required lay-verify="required" lay-verType="tips" placeholder="请输入编号"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="name" required lay-verify="required" lay-verType="tips" placeholder="请输入用户名"
                       autocomplete="off" class="layui-input">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" name="pass" required lay-verify="required" lay-verType="tips" placeholder="请输入密码"
                       autocomplete="off" class="layui-input">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" id="repeatpass" required lay-verify="required" lay-verType="tips"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="salt" required lay-verify="required" placeholder="" lay-verType="tips"
                       onfocus="tipSalt(this)" class="layui-input">
            </div>
