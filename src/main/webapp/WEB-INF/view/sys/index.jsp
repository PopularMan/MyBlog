...
<%@ include file="/WEB-INF/view/common/layui.jsp"%>
  ...
  <link href="${pageContext.request.contextPath}/resource/plug/skins/black.css" rel="stylesheet" id="skincss" type="text/css" />
<style>
.layui-side-scroll {
  width: 100%;
  height: 100%;
...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header animated fadeInDown">
    ...
    <ul class="layui-nav layui-layout-right">
      <li class="layui-nav-item"><a href="javascript:void(0)" class="chooseSkin"><i class="layui-icon">&#xe61b;</i>&nbsp;换肤功能</a></li>
      <li class="layui-nav-item"><a href="javascript:void(0)" class="msg"><i class="fa fa-volume-up"></i>&nbsp;我的消息<span class="layui-badge">9</span></a></li>
  ...
  <div class="layui-side layui-bg-black animated fadeInLeft" id="leftMenuDiv">
    ...
    <div class="layui-side-scroll">
      <div class="user-photo">
        <a class="img" title="我的头像"><img style="width: 80px;height: 80px" class="layui-circle" src="../resource/${admin.avatar}"></a>
        <p>你好！<span class="userName">${admin.username}</span></p>
      </div>
      <div class="circleimg" ><a  title="我的头像"><img style="width: 30px;height: 30px" class="layui-circle" src="../resource/${admin.avatar}"></a></div>
                ...
                <c:if test="${(pmenu.children)!= null && fn:length(pmenu.children) > 0}">
                    <dl class="layui-nav-child">
                      <c:forEach items="${pmenu.children}" var="menu">
                        ...
                        <dd><a href="javascript:;" data-url="${menu.url}"><i class="${menu.icon} fa-fw"></i>&nbsp;<cite>${menu.name}</cite></a></dd>
                        </c:if>
                      </c:forEach>
