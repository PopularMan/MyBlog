...
<script type="text/html" id="operaRole">
    <button href="" class="layui-btn layui-btn-xs" lay-event="searchPers"><i class="fa fa-search"></i>&nbsp;查询/分配权限
    </button>
    ...
    <form class="layui-form" action="" lay-filter="roleFrom" style="margin: 20px">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="role_code" required lay-verify="required" lay-verType="tips"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="role_name" required lay-verify="required" lay-verType="tips"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <textarea name="role_description" cols="30" rows="10" style="height:80px;"
