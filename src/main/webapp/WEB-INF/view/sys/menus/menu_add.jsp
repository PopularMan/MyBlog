        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="name" required lay-verify="required" value="${menu.name}"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="radio" name="type" lay-filter="type" value="menu" ${menu.type=="menu"?"checked":""}
                           title="菜单">
                    <input type="radio" name="type" lay-filter="type" value="button" ${menu.type=="button"?"checked":""}
                           title="按钮">
                    <input type="radio" name="type" lay-filter="type" value="pers" ${menu.type=="pers"?"checked":""}
                           title="权限">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="icon" name="icon" value="${menu.icon}" placeholder="图标" autocomplete="off"
                           class="layui-input">
                    <div class="icon">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="url" value="${menu.url}" placeholder="访问路径" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="percode" value="${menu.percode}" lay-verify="required" id="percode"
                           placeholder="权限代码" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item layui-form-text">
                <label class="layui-form-label">菜单排序:</label>
                <div class="layui-input-block">
                    <input type="text" name="sortstring" id="sort" value="${menu.sortstring}" placeholder="权限排序"
                           lay-verify="orderNum" autocomplete="off" class="layui-input">
                </div>
